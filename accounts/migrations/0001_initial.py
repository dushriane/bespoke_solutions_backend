    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('USER', 'User'), ('ADMIN', 'Admin'), ('BESPOKETEAM', 'Bespoke Team'), ('PARTNERS', 'Partners'), ('CUSTOMER', 'Customer')], default='CUSTOMER', max_length=20, verbose_name='user type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability_status', models.CharField(choices=[('AVAILABLE', 'Available'), ('BUSY', 'Busy'), ('OFFLINE', 'Offline'), ('UNKNOWN', 'Unknown')], default='UNKNOWN', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
